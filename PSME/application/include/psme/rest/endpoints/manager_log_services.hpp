 ...
 */
class ManagerLogServices : public EndpointBase {
public:

    /*!
     * @brief The constructor for ManagerLogServices class
     */
    explicit ManagerLogServices(const std::string& path);

    /*!
     * @brief ManagerLogServices class destructor
     */
    virtual ~ManagerLogServices();
