...
/*!
 * A class representing the rest api PonPortOnus endpoint
 */
class PonPortOnus : public EndpointBase {
public:

    /*!
     * @brief The constructor for PonPortOnus class
     */
    explicit PonPortOnus(const std::string& path);

    /*!
     * @brief PonPortOnus class destructor
     */
    virtual ~PonPortOnus();
