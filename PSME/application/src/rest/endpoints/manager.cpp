...
json::Value make_prototype() {
    ...
    r[Common::ODATA_TYPE] = "#Manager.v1_0_0.Manager";
    ...
    r[Common::LINKS][Common::ODATA_TYPE] = "#Manager.v1_0_0.Links";
...
void endpoint::Manager::get(const server::Request& req, server::Response& res) {
    ...
    r[Common::UUID] =  ServiceUuid::get_instance()->get_service_uuid();
     ...
     * */
    r[constants::Manager::DATE_TIME] = agent_framework::utils::make_iso_8601_timestamp();
     r[constants::Manager::DATE_TIME_LOCAL_OFFSET] = agent_framework::utils::make_iso_8601_timezonestamp();
    r[constants::Manager::SERIAL_CONSOLE] = console_to_json(manager.get_serial_console());
    ...
    r[constants::Manager::SERIAL_INTERFACES][Common::ODATA_ID] =
        PathBuilder(req).append(constants::Manager::SERIAL_INTERFACES).build();

    r[constants::Manager::LOG_SERVICES][Common::ODATA_ID] =
        PathBuilder(req).append(constants::Manager::LOG_SERVICES).build();
