...
// Step 1 
    ...
    mp.register_handler(EthernetSwitchPortOnusOmci::UPtr(
        new EthernetSwitchPortOnusOmci(constants::Routes::ONUS_COLLECTION_ONUS_OMCI_PATH)));
    ...
    mp.register_handler(OltFlowId::UPtr(
        new OltFlowId(constants::Routes::FLOW_ID_PATH)));
