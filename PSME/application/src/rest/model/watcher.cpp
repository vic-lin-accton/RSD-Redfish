...
class WallClock_5secTask : public WatcherTask {
public:
    WallClock_5secTask();
...
WallClock_5secTask::WallClock_5secTask() : WatcherTask("WallClock_5secTask") {

}


void WallClock_5secTask::execute() {
using namespace psme::rest::account::manager;
	
	AccountManager::get_instance()->timekick(std::chrono::steady_clock::now());
...
Watcher::Watcher() {
    ...
    add_task(std::unique_ptr<WatcherTask>(new WallClock_5secTask()));
}
