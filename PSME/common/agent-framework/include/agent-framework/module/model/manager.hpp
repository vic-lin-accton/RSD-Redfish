...
/*Nick Added Begin: */
     ...
     * @return m_onlp_max_thermal_sensor
     */
     ...
     * @set m_onlp_max_thermal_sensor
     */
    void set_max_thermal_sensor_num(const std::uint32_t num) {
        m_onlp_max_thermal_sensor = num ;
    }

    /*!
     * @brief Get max psu number
     * @return m_onlp_max_psu
     */
    ...
    /*!
     * @brief Set m_onlp_max_psu number
     * @set m_onlp_max_psu
     */
     ...
     * @return onlp_max_port
     */
    std::uint32_t get_max_port_num() const {
        return m_onlp_max_port;
    }
...
private:
    ...
    std::uint32_t m_slot{};
/*Nick Added Begin: */	
    std::uint32_t m_onlp_max_fan{};
    std::uint32_t m_onlp_max_thermal_sensor{};  
    std::uint32_t m_onlp_max_psu{};     
    std::uint32_t m_onlp_max_port{};	
#ifdef CSUBSYSTEM
    std::uint32_t m_onlp_max_cpu{};	
    ...
    std::uint32_t m_onlp_max_memory{};	
    std::uint32_t m_onlp_max_drv{};	
