...
/*Nick Added Begin: */
    result[literals::PowerZone::CHASSIS] = get_chassis();    
    result[literals::PowerZone::PZ_ID]  = get_pz_id();     	
/*Nick Added End  : */		
    return result;
}
...
/*Nick Added Begin: */
    zone.set_chassis(json[literals::PowerZone::CHASSIS]);   
    zone.set_pz_id(json[literals::PowerZone::PZ_ID]);       
/*Nick Added End  : */	
