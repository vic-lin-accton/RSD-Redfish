...
res=`curl --insecure  -v  -X PATCH -d '{"AdministrativeState" : "Up"}'  https://"$1":8888/redfish/v1/EthernetSwitches/1/Ports/65/`

sleep 1 

res=`curl --insecure  -v  -X POST -d '{"onu_id":1,"vendor_id":"ISKT","vendor_specific":"428DA323"}' https://"$1":8888/redfish/v1/EthernetSwitches/1/Ports/1/ONUs `
