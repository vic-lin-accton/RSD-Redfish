...
#define DRAWER_PSUPWR_STR              "psu_output"        //vic add
...
extern result_t libwrap_get_drawer_psu_power_by_node_id(memdb_integer drawer_node_id, uint32 *pwr); //vic add
