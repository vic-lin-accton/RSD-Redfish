...
void register_drawer_handler(void)
{
	...
	register_handler(DRAWER9_URL, &drawer_handler);
	register_handler(DRAWER10_URL, &drawer_handler);
	register_handler(DRAWER11_URL, &drawer_handler);
	register_handler(DRAWER12_URL, &drawer_handler);
	register_handler(DRAWER13_URL, &drawer_handler);
	register_handler(DRAWER14_URL, &drawer_handler);

	register_handler(DRAWER15_URL, &drawer_handler);
	register_handler(DRAWER16_URL, &drawer_handler);
	register_handler(DRAWER17_URL, &drawer_handler);
	register_handler(DRAWER18_URL, &drawer_handler);
	
	register_handler(DRAWER19_URL, &drawer_handler);
	register_handler(DRAWER20_URL, &drawer_handler);
	register_handler(DRAWER21_URL, &drawer_handler);
	register_handler(DRAWER22_URL, &drawer_handler);
	register_handler(DRAWER23_URL, &drawer_handler);
	register_handler(DRAWER24_URL, &drawer_handler);	
	register_handler(DRAWER25_URL, &drawer_handler);
	register_handler(DRAWER26_URL, &drawer_handler);
	register_handler(DRAWER27_URL, &drawer_handler);
	register_handler(DRAWER28_URL, &drawer_handler);

	register_handler(DRAWER29_URL, &drawer_handler);
	register_handler(DRAWER30_URL, &drawer_handler);
	register_handler(DRAWER31_URL, &drawer_handler);
	register_handler(DRAWER32_URL, &drawer_handler);
	register_handler(DRAWER33_URL, &drawer_handler);
	register_handler(DRAWER34_URL, &drawer_handler);

	register_handler(DRAWER35_URL, &drawer_handler);
	register_handler(DRAWER36_URL, &drawer_handler);	
	register_handler(DRAWER37_URL, &drawer_handler);
	register_handler(DRAWER38_URL, &drawer_handler);

	register_handler(DRAWER39_URL, &drawer_handler);
	register_handler(DRAWER40_URL, &drawer_handler);
	register_handler(DRAWER41_URL, &drawer_handler);
	register_handler(DRAWER42_URL, &drawer_handler);
	register_handler(DRAWER43_URL, &drawer_handler);
	register_handler(DRAWER44_URL, &drawer_handler);

	register_handler(DRAWER45_URL, &drawer_handler);
	register_handler(DRAWER46_URL, &drawer_handler);	
	register_handler(DRAWER47_URL, &drawer_handler);		
	register_handler(DRAWER48_URL, &drawer_handler);
...
//printf("dzone_idx %d drawer_idx %d\n",dzone_idx,drawer_idx);  	
