...
typedef struct drawers_data {
	...
	fn_cond_t  set_drawers_rack_puid;
        ...
        fn_cond_t  get_drawers_rack_location_id;
        fn_cond_t  set_drawers_rack_location_id;
	...
	int        puid[MAX_DRAWER_NUM];
        uint8      location_id[MAX_DRAWER_NUM][MAX_LOCATION_ID_LEN];
	...
	int32      drawer_psupwr[MAX_DRAWER_NUM];
} drawers_data_t;
...
typedef struct dzone_data {
	...
	int8       present;
	int64      present64;
	int32      drawer_power[MAX_DRAWER_NUM]; /* viclin added for store drawer's power*/
	int32      drawer_psupwr[MAX_DRAWER_NUM];   /* viclin added for store drawer's power*/
	int32      drawer_pwrcap[MAX_DRAWER_NUM]; /* viclin added for store drawer's power*/
	int32      total_pwrcap;
...
extern void record_rack_location_id(char* location_id);
extern char* get_rack_location_id();
