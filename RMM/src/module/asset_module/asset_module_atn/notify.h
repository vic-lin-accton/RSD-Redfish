...
//int notify_pzone_total_power_consum_change(am_node_t *pz, int pwr_consum); //viclin add
...
int notify_drawer_present_change64(am_node_t *tz, int64 present);
...
int notify_drawer_psupwr_change(am_node_t *drawers, unsigned int power); // vic added
